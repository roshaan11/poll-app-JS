...
class poll{
    constructor(pollTitle,pollDescription,pollOptions,timestamp,userId,pollId){
...
let pollCreation=()=>{
    ...
    const pollInfo=new poll(pollTitle.value,pollDescription.value,gettingAllInputs(),now.toDateString(),currentPersonId,Date.now());
